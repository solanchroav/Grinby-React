  ...
  render() {
      return (
          ...
          <nav className="nav-login">
              ...
              <div className="span3">
                <img src='' alt="Logo de la marca" className="imagen-logo" width="50%" height="50%"/>
              </div>
        ...
        <div className="foto-de-frase global">
          <img src='' alt="imagen de inicio" className="imagen-banner"/>
          <div className="frase">
      ...
      <div className="search">
        <div className="search-text">Encuentra todos los negocios asociados</div>
          ...
          <img src='' alt="foto concepto" className="foto-concept"/>
        </div>
        <div className="participa">
            ...
            <img src='' alt="foto concepto" className="foto-participa"/>
          </div>
      ...
      <div className="outstaning-blog-post global">
        ...
        <div className="item-post global">
            <img src='' alt="imagen del post" className="img-post"/>
      ...
      <div className="links global">
        <ul className="info-imp">
          ...
          <span className="pie">
            <img src='' alt="logo de Grinby" width="15%" height="7%" className="logo-pie"/>
            <div className="icon">
